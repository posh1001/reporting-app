    ...
    <div x-show="showModal" x-cloak
        ...
        <div @click.away="showModal = false"
            ...
            <form action="/outdoor" method="POST" class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-500 mb-1">Avaliable Slots</label>
                    <input type="number" name="avaliable_slots" placeholder="0"
                ...
                <div>
                    ...
                    <input type="number" name="total_podcast_required" placeholder="0"
                        class="w-full px-4 py-2 rounded-lg border border-gray-700 bg-gray-800 text-white placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                </div>
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-500 mb-1">Seats Reserved</label>
                    <input type="number" name="seats_reserved" placeholder="0"
                        class="w-full px-4 py-2 rounded-lg border border-gray-700 bg-gray-800 text-white placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                </div>
                  <div>
                    <label class="block text-sm font-medium text-gray-500 mb-1">Numbers of invitees so far</label>
                    <input type="number" name="number_of_invitees_so_far" placeholder="0"
                        class="w-full px-4 py-2 rounded-lg border border-gray-700 bg-gray-800 text-white placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                </div>
                <div>
