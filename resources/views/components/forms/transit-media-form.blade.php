    ...
    <div @click="showModal = true" class="cursor-pointer relative rounded-2xl overflow-hidden max-w-md mx-auto group">
        ...
        <div
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h2 class="text-lg font-semibold text-white">Transit Media <br>Report</h2>
    ...
    <div x-show="showModal" x-cloak
        ...
        <div @click.away="showModal = false"
            ...
            <div class="flex items-center gap-4 border-b border-gray-700 pb-4">
                ...
                <div>
                    <h2 class="text-xl font-semibold text-white">Transit Media <br> Report</h2>
            ...
            <form action="/transit-media" method="POST" class="grid grid-cols-2 gap-6"
                ...
                <div>
                    <label class="block text-xs font-medium text-gray-500 mb-1">Total number commissioned in Ibeju
                        Lekki</label>
