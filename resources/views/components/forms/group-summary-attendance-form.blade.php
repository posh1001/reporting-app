  ...
  <div @click="showModal = true" class="cursor-pointer relative rounded-2xl overflow-hidden max-w-md mx-auto group">
    ...
    <div
      ...
      <div class="flex items-center gap-4">
        ...
        <div>
          <h2 class="text-lg font-semibold text-white">Group Summary<br>Attendance Report</h2>
  ...
  <div x-show="showModal" x-cloak
    ...
    <div @click.away="showModal = false"
      ...
      <div class="flex items-center gap-4 border-b border-gray-700 pb-4">
        ...
        <div>
          <h2 class="text-xl font-semibold text-white">Group Summary <br>Attendance Report</h2>
          <p class="text-sm text-gray-400">Please complete the form below to submit your report.</p>
        </div>
      </div>

      <!-- Form Body -->
      <form action="/church-reg-report" method="POST" class="grid grid-cols-1 overflow-auto xs:grid-cols-2 md:grid-cols-3 gap-4 w-full"
>
        @csrf
        ...
        <div>
          <label class="block text-sm font-medium text-gray-500 mb-1">Numbers Confirmed Today</label>
          <input type="number" name="confirmed_today" placeholder="0"
            class="w-full px-4 py-2 rounded-lg border border-gray-700 bg-gray-800 text-white placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:outline-none">
        </div>
        ...
        <!-- Yet to be Invited -->
        <div>
          <label class="block text-sm font-medium text-gray-500 mb-1">Yet to be Invited</label>
        ...
        <div>
          ...
          <input type="number" name="number_coming_with_cars" placeholder="0"
            class="w-full px-4 py-2 rounded-lg border border-gray-700 bg-gray-800 text-white placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:outline-none">
        </div>

        <!-- Number coming with bus -->
        <div>
          <label class="block text-sm font-medium text-gray-500 mb-1">Number coming with bus</label>
          <input type="number" name="number_coming_with_bus" placeholder="0"
            class="w-full px-4 py-2 rounded-lg border border-gray-700 bg-gray-800 text-white placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:outline-none">
        </div>
