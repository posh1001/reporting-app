...
<div x-data="{ showModal: false }">
    ...
    <div x-show="showModal" x-cloak
        ...
        <div @click.away="showModal = false"
            ...
            <!-- Form Body -->
            <form action="/tv" method="POST" class="grid grid-cols-2 gap-6"
                style="overflow: auto">
                @csrf
                ...
                <div>
                    <label class="block text-xs font-medium text-gray-500 mb-1">Total slot yet to be
                        commissioned</label>
                ...
                <div class="col-span-2 flex justify-end pt-4">
                    <button type="submit"
                        class="bg-blue-950  hover:from-blue-700 hover:to-indigo-700 text-white py-2 px-6 rounded-lg shadow-lg transition">
                        Submit Report
                    </button>
                </div>
            </form>
