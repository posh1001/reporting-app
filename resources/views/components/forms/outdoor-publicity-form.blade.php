    ...
    <div x-show="showModal" x-cloak
        ...
        <div @click.away="showModal = false"
            ...
            <form action="/outdoor" method="POST" class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                    <label class="block text-sm text-gray-500 mb-1">Select LGA</label>
                    <select name="lga"
                        class="w-full px-4 text-white bg-gray-900 hover-white py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
                        required>
