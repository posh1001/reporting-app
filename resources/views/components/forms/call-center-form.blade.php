    ...
    <div @click="showModal = true"
        ...
        <div class="relative bg-gray-900/90 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-2xl transform hover:-translate-y-1 hover:scale-[1.02] transition-all duration-300 p-6 border border-gray-700">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h2 class="text-lg font-semibold text-white">Call Center <br> Report</h2>
    ...
    <div x-show="showModal" x-cloak
        ...
        <div @click.away="showModal = false"
            ...
            <div class="flex items-center gap-4 border-b border-gray-700 pb-4">
                ...
                <div>
                    <h2 class="text-xl font-semibold text-white">Call Center  Report</h2>
                    <p class="text-sm text-gray-400">Please complete the form below to submit your report.</p>
                </div>
            </div>

            <!-- Form -->
            <form action="/call-center-report" method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-6">
                @csrf
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-500 mb-1">Database Type</label>
                    <input type="text" name="database_type" placeholder="eg. members db, FT db, invitees db"
                        class="w-full px-4 py-2 rounded-lg border border-gray-700 bg-gray-800 text-white
                               placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                </div>
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-500 mb-1">Number Confirmed Today</label>
                    <input type="number" name="number_confirmed_today" placeholder="0"
                        class="w-full px-4 py-2 rounded-lg border border-gray-700 bg-gray-800 text-white
                               placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="number_yet_to_confirm" placeholder="0"
                        class="w-full px-4 py-2 rounded-lg border border-gray-700 bg-gray-800 text-white
                               placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="number_expecting_healing" placeholder="0"
                        class="w-full px-4 py-2 rounded-lg border border-gray-700 bg-gray-800 text-white
                               placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                </div>
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-500 mb-1">Location They Are Coming From</label>
                    <input type="text" name="location_coming_from" placeholder="Enter location"
                        class="w-full px-4 py-2 rounded-lg border border-gray-700 bg-gray-800 text-white
                               placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                </div>
