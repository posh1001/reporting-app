<div class="bg-white rounded-xl shadow overflow-hidden">
    <div class="p-6 border-b border-gray-200 flex items-center justify-between">
        <h2 class="text-lg font-semibold text-gray-800">Group Overall Registration Report</h2>
        ...
        <table class="min-w-full text-sm">
            <thead class="bg-gray-50 text-gray-600 uppercase tracking-wider text-xs">
                <tr>
                    ...
                    <th class="px-6 py-3 text-left">Number Confirmed Via Call</th>
                    <th class="px-6 py-3 text-left">Total Expected Attendance</th>
                    <th class="px-6 py-3 text-left">Number Expecting Healing</th>
                    <th class="px-6 py-3 text-left">Total Yet To Be Invited</th>
                </tr>
            </thead>
            <tbody class="divide-y divide-gray-100">
                @foreach ($groupRegisterationReports as $report)
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-6 py-4 font-bold">{{ $report['Number Confirmed Via Call'] }}</td>
                        <td class="px-6 py-4 text-green-700 font-bold">{{ $report['Total Expected attendance'] }}</td>
                        <td class="px-6 py-4 font-bold">{{ $report['Number Expecting Healing'] }}</td>
                        <td class="px-6 py-4 text-indigo-600 font-bold">{{ $report['Total Yet To Be Invited'] }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
