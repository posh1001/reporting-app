<div class="bg-white rounded-xl shadow overflow-hidden">
    <div class="p-6 border-b border-gray-200 flex items-center justify-between">
        <h2 class="text-lg font-semibold text-gray-800">Church Summary Attendance Report</h2>
    ...
    <div class="overflow-x-auto">
        <table class="min-w-full text-sm">
            ...
            <tbody class="divide-y divide-gray-100">
                @foreach ($churchAttendanceReports as $report)
                    <tr class="hover:bg-gray-50 transition">
                        <td class="px-6 py-4 font-medium text-gray-800">{{ $report['Church'] }}</td>
                        <td class="px-6 py-4 text-yellow-600">{{ $report['Membership Strength'] }}</td>
                        <td class="px-6 py-4">{{ $report['Number Confirmed Today'] }}</td>
